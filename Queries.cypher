MATCH (j:Juego)-[:HAS_GENRE]->(g:Genero)
...
MATCH (j:Juego)-[:DEVELOPER]->(e:Empresa)
...
MATCH (j:Juego)-[:AVAILABLE_ON]->(p:Plataforma)
...
MATCH (j:Juego)
OPTIONAL MATCH (j)-[:HAS_TAG]->(t:Etiqueta)
OPTIONAL MATCH (j)-[:HAS_GENRE]->(g:Género)
...
MATCH (j:Juego)-[:HAS_GENRE]->(g:Género)
